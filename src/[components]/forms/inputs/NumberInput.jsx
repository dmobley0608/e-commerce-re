...
export default function NumberInput({ name, label, step, register, errors, errorMessage, type, placeholder, required, value }) {
    return (
        <div className='relative mb-6 w-full'>
            ...
            <input type={type} step={step} className='form-input px-4 py-3 rounded-lg w-full' value={value}
